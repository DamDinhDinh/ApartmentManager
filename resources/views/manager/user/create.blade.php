...
@section('content')
    ...
    <form class="form" method="POST" action="{{route('user.store')}}">
        ...
        <div class="row">
            ...
            <input type="text" class="form-control col-md-10" name="name" placeholder="VD: Nguyễn Văn A">
        </div>
        <div class="row">
                <label class="col-md-2"for="userPhoneNumber">Nhập SĐT: </label>
                <input type="tel" class="form-control col-md-10" name="phoneNumber" placeholder="VD: 0987654321">
        </div>
        <div class="row">
                <label class="col-md-2"for="userEMail">Nhập email</label>
                <input type="email" class="form-control col-md-10" name="email" placeholder="VD: anv@gmail.com">
        </div>
        <div class="row">
        ...
        <div class="row">
                ...
                <input type="number" class="form-control col-md-10" name="apartmentID" placeholder="VD: 0">
        </div>
        <div class="row">
