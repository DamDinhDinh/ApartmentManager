...
@section('content')
    ...
    <form class="form" method="POST" action="{{route('bill.store', ['usingService' => Route::input('usingService'), 'useData' => Route::input('useData')])}}">
        {{csrf_field()}}
        <div class="row">
        ...
        <div class="row form-group">
            ...
            <input id= "priceInput" class="form-control col-md-10 value-input" name="price" type="number" value="{{$usingService->service->price}}" min="0" readonly oninput="validity.valid||(value=0);">
        </div>
        <div class="row form-group">
            <label  class="col-md-2" for="useValue">Giảm giá (%): </label>
            <input  id= "discountInput" class="form-control col-md-10 value-input" name="discount" type="number" value="0" min="0" max="100" oninput="validity.valid||(value=0);">
        </div>
        <div class="row form-group">
            <label  class="col-md-2" for="useValue">VAT (%): </label>
            <input id= "vatInput" class="form-control col-md-10 value-input" name="vat" type="number" value="0" min="0" max="100" oninput="validity.valid||(value=0);">
        </div>
        @php
        ...
        <div class="text-right" style="margin-top: 10px">
            <button class="btn btn-primary float-right" type="submit">Thêm hóa đơn</button>
        </div>
